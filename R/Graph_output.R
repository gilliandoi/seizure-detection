...
readMatFile <- function(path){
	...
	fileAccount=timeTotal/series-1
		...
		#出力ファイル名
		outputFile <- paste("図__源波形.bmp",sep="")
		...
		#出力ファイル名
		outputFile <- paste("図__脳波.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		plot(0:(length(outputData)-1),outputData,type="l",xlab="時間",ylab="振幅",cex.axis = 1.8)
		#出力ファイル名
		outputFile <- paste("図__振幅-平均加算.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		#出力ファイル名
		outputFile <- paste("図__源周波数波形.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		#出力ファイル名
		outputFile <- paste("図__周波数波形_16.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		plot(0:(length(outputData)-1),outputData,type="l",xlab="時間",ylab="周波数",cex.axis = 1.8)
		#出力ファイル名
		outputFile <- paste("図__周波数-平均加算.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		par(oma = c(2, 2, 2, 2)) 
		#row1だけ（図抽出用）
		plot(data[1,],type="l",xlab="時刻(s)",ylab="振幅",cex.axis = 1.8,col=4)
		#出力ファイル名
		outputFile <- paste("図_時系列解析法.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		par(oma = c(2, 2, 2, 2)) 
		#row1だけ（図抽出用）
		plot(0:(length(fft(data[1,]))-1),fft(data[1,]),type="l",xlab="時刻(s)",ylab="周波数",cex.axis = 1.8,col=4)
		#出力ファイル名
		outputFile <- paste("図_周波数解析法.bmp",sep="")
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
		...
		#出力ファイル名
		outputFile <- paste("図_時間周波数解析法.bmp",sep="",col=4)
		dev.copy(bmp,outputFile,width=outWidth,height=outHeight)
		dev.off()
